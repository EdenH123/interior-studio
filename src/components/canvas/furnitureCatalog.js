...
export const FURNITURE = [
  ...
  // ── Kitchen ───────────────────────────────────────────────────────────────
  { type: 'kitchen-sink',   label: 'Kitchen sink',   category: 'Kitchen', width: 0.80, depth: 0.60, height: 0.90, color: '#9eaab0', model: glb('kitchen-sink.glb'),   parts: [{ key: 'cabinet', label: 'Cabinet' }, { key: 'sink', label: 'Sink' }, { key: 'chrome', label: 'Chrome' }] },
  { type: 'fridge',         label: 'Fridge',         category: 'Kitchen', width: 0.70, depth: 0.70, height: 1.85, color: '#9eaab0', model: glb('fridge.glb'),         parts: [{ key: 'body', label: 'Body' }, { key: 'doors', label: 'Doors' }, { key: 'handles', label: 'Handles' }] },
  { type: 'oven',           label: 'Oven',           category: 'Kitchen', width: 0.60, depth: 0.60, height: 0.90, color: '#4b5563', model: glb('oven.glb'),           parts: [{ key: 'body', label: 'Body' }, { key: 'glass', label: 'Glass' }, { key: 'accents', label: 'Accents' }] },
  { type: 'dishwasher',     label: 'Dishwasher',     category: 'Kitchen', width: 0.60, depth: 0.60, height: 0.85, color: '#4b5563', model: glb('dishwasher.glb'),     parts: [{ key: 'body', label: 'Body' }, { key: 'controls', label: 'Controls' }, { key: 'handle', label: 'Handle' }] },
  { type: 'microwave',      label: 'Microwave',      category: 'Kitchen', width: 0.55, depth: 0.35, height: 0.32, color: '#4b5563', model: glb('microwave.glb'),      wallMounted: true, mountHeight: 1.4, parts: [{ key: 'body', label: 'Body' }, { key: 'glass', label: 'Glass' }, { key: 'handle', label: 'Handle' }] },
  { type: 'upper-cabinet',  label: 'Upper cabinet',  category: 'Kitchen', width: 0.60, depth: 0.35, height: 0.70, color: '#c4b49a', model: glb('upper-cabinet.glb'), wallMounted: true, mountHeight: 1.45, parts: [{ key: 'body', label: 'Body' }, { key: 'handle', label: 'Handle' }] },
  { type: 'range-hood',     label: 'Range hood',     category: 'Kitchen', width: 0.60, depth: 0.40, height: 0.35, color: '#9eaab0', model: glb('range-hood.glb'),     wallMounted: true, mountHeight: 1.75, parts: [{ key: 'body', label: 'Body' }, { key: 'grille', label: 'Grille' }] },
  { type: 'kitchen-island', label: 'Kitchen island', category: 'Kitchen', width: 1.50, depth: 0.80, height: 0.90, color: '#c4b49a', model: glb('kitchen-island.glb'), parts: [{ key: 'cabinet', label: 'Cabinet' }, { key: 'counter', label: 'Counter' }, { key: 'handles', label: 'Handles' }] },
  { type: 'pantry-unit',    label: 'Pantry unit',    category: 'Kitchen', width: 0.60, depth: 0.60, height: 2.00, color: '#c4b49a', model: glb('pantry-unit.glb'),    parts: [{ key: 'body', label: 'Body' }, { key: 'handles', label: 'Handles' }] },
  { type: 'bar-stool',      label: 'Bar stool',      category: 'Kitchen', width: 0.40, depth: 0.40, height: 0.75, color: '#a16207', model: glb('bar-stool.glb'),      parts: [{ key: 'seat', label: 'Seat' }, { key: 'base', label: 'Base' }, { key: 'footrest', label: 'Footrest' }] },
