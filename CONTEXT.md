...
- [ ] Populate actual `.glb` files in `src/assets/furniture/` and wire each into `furnitureCatalog.js`. The pipeline is in place; this is just content + 12 catalog edits.
